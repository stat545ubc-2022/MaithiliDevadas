...
ggplot(cancer_sample, aes(x=compactness_mean, y=texture_mean, shape=diagnosis, color=diagnosis)) + labs(title="Relationship between radius and texture", x="Compactness Mean", y="Texture Mean") +
  geom_point() + geom_smooth(method=lm, se=FALSE, fullrange=TRUE)
